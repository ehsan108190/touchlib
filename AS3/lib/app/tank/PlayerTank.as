...
package app.tank
{
	...
	{
		private var leftTread:TouchlibSlider;
		private var rightTread:TouchlibSlider;
		...
		private var turretKnob:TouchlibKnob;
		...
		function PlayerTank(mc:TankGame, n:Number)
		{
			...
			leftTread = new TouchlibSlider(50, 150);
			leftTread.x = -100;
			leftTread.y = -100;
			leftTread.setValue(0.5);
			UIHolder.addChild(leftTread);
			
			rightTread = new TouchlibSlider(50, 150);
			rightTread.x = 0;
			rightTread.y = -100;
			rightTread.setValue(0.5);
			UIHolder.addChild(rightTread);
			
			turretKnob = new TouchlibKnob(100);
			turretKnob.x = 100;
			turretKnob.y = -100;
			...
			var tempobj:TouchlibWrapper = new TouchlibWrapper(fireButton);
			tempobj.x = 100;
			tempobj.y = 0;
