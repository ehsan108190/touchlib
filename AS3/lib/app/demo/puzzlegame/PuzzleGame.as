/* 
Class/Package name: PuzzleGame
Description: Multitouch Puzzle game
...
References:
	Based on the example: http://www.adobe.com/devnet/flash/samples/puzzle_game/
	
Puzzle images need to be resized to 800x600 and added manual into the sourcecode.
*/
...
package app.demo.puzzlegame {
	...
	public class PuzzleGame extends MovieClip
	{
		...
		function DifficultySelectionButtons() {
			...
			easy_mode.graphics.beginFill(0x00FF00,1.0);
			easy_mode.graphics.drawRect(512, 700, 80, 40);
			...
			medium_mode.graphics.beginFill(0x00BFFF,1.0);
			medium_mode.graphics.drawRect(612, 700, 80, 40);
			...
			hard_mode.graphics.beginFill(0xFFD700,1.0);
			hard_mode.graphics.drawRect(712, 700, 80, 40);
			...
			insane_mode.graphics.beginFill(0xFF0000,1.0);
			insane_mode.graphics.drawRect(812, 700, 80, 40);
		...
		public function init(piecesx:Number, piecesy:Number)
		{
			...
			imagesArr = new Array("puzzle1.jpg", "puzzle2.jpg", "puzzle3.jpg", "puzzle4.jpg");
			...
			requestURL = new URLRequest("PuzzleGameImages/" + imagesArr[index]);
