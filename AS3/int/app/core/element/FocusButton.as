package app.core.element{	
	...
	public class FocusButton extends Sprite{		
		...
		closeButton.graphics.beginFill(0xFFFFFF,0);	
		...
		Tweener.addTween(closeButton, {alpha: 2, scaleX: 1.5, scaleY: 1.5, delay:0,time:0.5, transition:"easeinoutquad"});
		...
		Tweener.addTween(closeButton, {alpha: 0.5, scaleX: 1.0, scaleY: 1.0, delay:0,time:0.5, transition:"easeinoutquad"});
