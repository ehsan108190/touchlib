...
package General{
	...
	public class Input{
		...
		public function Input(stageMc:Sprite){
			...
			// touch listeners
			stageMc.stage.addEventListener(TUIOEvent.TUIO_DOWN, mousePress, false, 0, true);
			stageMc.stage.addEventListener(TUIOEvent.TUIO_UP, mouseRelease, false, 0, true);
			stageMc.stage.addEventListener(TUIOEvent.TUIO_MOVE, mouseMove, false, 0, true);
		...
		// mousePress listener
		//======================
		public function mousePress(e:Event){
			mouseDown = true;
		}
		...
		// mousePress listener
		//======================
		public function mouseRelease(e:Event){
			mouseDown = false;
			mouseReleased = true;
		}
